...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2025 a las 17:22:50
...
(1, 'Administrador', '', '2025-12-01 16:14:28');
...
(1, 1, 'index.php', 'view', '2025-12-01 16:14:38'),
(2, 1, 'roles.php', 'view', '2025-12-01 16:14:38'),
(3, 1, 'users.php', 'view', '2025-12-01 16:14:38'),
(4, 1, 'attendance_reports_list_admin.php', 'view', '2025-12-01 16:14:38'),
(5, 1, 'attendance_report_admin.php', 'view', '2025-12-01 16:14:38'),
(6, 1, 'attendance_reports_admin_teachers.php', 'view', '2025-12-01 16:14:38'),
(7, 1, 'backup.php', 'view', '2025-12-01 16:14:38');
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `password`, `status`, `created_at`, `role_id`) VALUES
(1, 'Jean', 'Lobos', 'Agustin500cm@gmail.com', '$2y$10$pKmB57JtsucQ9X8Kuk1QyukJnQ96eLBFOGHiFLjkL1nr3oH43OCXO', 1, '2025-12-01 16:18:26', 1);
...
--
ALTER TABLE `stock_history`
  MODIFY `id_stock_h` int(11) NOT NULL AUTO_INCREMENT;
