...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2025 a las 23:31:21
...
CREATE TABLE `cash` (
  ...
  `type` enum('income','expense') NOT NULL COMMENT 'Tipo de movimiento: ingreso o egreso',
  `amount` decimal(10,2) NOT NULL COMMENT 'Monto del movimiento',
  `reference_type` enum('sale','purchase','return') DEFAULT NULL COMMENT 'Tipo de referencia relacionada',
  `reference_id` int(11) DEFAULT NULL COMMENT 'ID de la venta, compra o devolución',
  `description` varchar(255) DEFAULT NULL COMMENT 'Detalle del movimiento',
  `created_at` datetime DEFAULT current_timestamp() COMMENT 'Fecha del movimiento'
...
INSERT INTO `cash` (`id_cash`, `type`, `amount`, `reference_type`, `reference_id`, `description`, `created_at`) VALUES
(1, 'income', 3500.00, 'sale', 8, 'Venta', '2025-09-28 18:30:15'),
(2, 'income', 7000.00, 'sale', 9, 'Venta', '2025-09-28 18:30:34');
...
(4, 'Ocasional', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Activo', NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, '2025-09-28 18:27:14', NULL);
...
CREATE TABLE `returns` (
  ...
  `type` enum('sale','purchase') NOT NULL COMMENT 'Devolución a cliente o proveedor',
  `reference_id` int(11) NOT NULL COMMENT 'ID de la venta o compra original',
  `total` decimal(10,2) NOT NULL,
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `sales` (`id_sale`, `id_client`, `total`, `created_at`) VALUES
(8, NULL, 3500.00, '2025-09-28 18:30:15'),
(9, 3, 7000.00, '2025-09-28 18:30:34');
...
INSERT INTO `sale_items` (`id_item`, `id_sale`, `id_stock`, `quantity`, `price`, `subtotal`) VALUES
(1, 8, 2, 1.00, 3500.00, 3500.00),
(2, 9, 2, 2.00, 3500.00, 7000.00);
...
(2, 'Mouse Logitech M90', 2, 2, 'MOUSEM90', '7790987654321', 'Mouse óptico USB Logitech M90', 'Logitech', 2000.00, 3500.00, 47.00, 10.00, 21.00, 'mouse_logitech_m90.jpg', 'Activo', '2025-09-28 13:16:08', '2025-09-28 18:30:34'),
...
CREATE TABLE `stock_history` (
  `id_stock_h` int(11) NOT NULL,
  `id_stock` int(11) NOT NULL,
  `type` enum('sale','purchase','return','adjustment') NOT NULL,
...
INSERT INTO `stock_history` (`id_stock_h`, `id_stock`, `type`, `reference_id`, `quantity`, `created_at`) VALUES
(1, 2, 'sale', 8, 1.00, '2025-09-28 18:30:15'),
(2, 2, 'sale', 9, 2.00, '2025-09-28 18:30:34');
...
--
ALTER TABLE `clients`
  MODIFY `id_client` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del cliente', AUTO_INCREMENT=5;
...
--
ALTER TABLE `stock_history`
  MODIFY `id_stock_h` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `purchase_items`
  ADD CONSTRAINT `purchase_items_ibfk_1` FOREIGN KEY (`id_purchase`) REFERENCES `purchases` (`id_purchase`),
  ADD CONSTRAINT `purchase_items_ibfk_2` FOREIGN KEY (`id_stock`) REFERENCES `stock` (`id_stock`);

--
-- Filtros para la tabla `return_items`
--
ALTER TABLE `return_items`
  ADD CONSTRAINT `return_items_ibfk_1` FOREIGN KEY (`id_return`) REFERENCES `returns` (`id_return`),
  ADD CONSTRAINT `return_items_ibfk_2` FOREIGN KEY (`id_stock`) REFERENCES `stock` (`id_stock`);

--
-- Filtros para la tabla `sales`
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `clients` (`id_client`);

--
-- Filtros para la tabla `sale_items`
--
ALTER TABLE `sale_items`
  ADD CONSTRAINT `sale_items_ibfk_1` FOREIGN KEY (`id_sale`) REFERENCES `sales` (`id_sale`),
  ADD CONSTRAINT `sale_items_ibfk_2` FOREIGN KEY (`id_stock`) REFERENCES `stock` (`id_stock`);
...
--
ALTER TABLE `stock_history`
  ADD CONSTRAINT `stock_history_ibfk_1` FOREIGN KEY (`id_stock`) REFERENCES `stock` (`id_stock`);
COMMIT;
